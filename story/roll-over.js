(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("RollOver", [], factory);
	else if(typeof exports === 'object')
		exports["RollOver"] = factory();
	else
		root["RollOver"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.modes = exports.init = undefined;
	...
	__webpack_require__(/*! whatwg-fetch */ 298);
	...
	var textures = void 0;
	var tileVertexPositionBuffers = void 0;

	var sampleTexture = void 0;
	var sampleTextureFramebuffer = void 0;

	var samplingScreenTextureCoordBuffer = void 0;
	var samplingScreenIndexBuffer = void 0;

	var mainScreenVertexPositionBuffer = void 0;
	var mainScreenTextureCoordBuffer = void 0;
...
// console.log((story[sNo].size*story[sNo].no),fakeScroll.style.height);
	...
	function getShader(id) {
	  return fetch(id + '.glsl').then(function (res) {
	    return res.text();
	...
	function initProgram(_ref) {
	  var vertexShaderID = _ref.vertexShaderID;
	  var fragmentShaderID = _ref.fragmentShaderID;
	  var attributes = _ref.attributes;
	  var uniforms = _ref.uniforms;

	  Promise.all([getShader(vertexShaderID), getShader(fragmentShaderID)]).then(function (_ref2) {
	    var _ref3 = _slicedToArray(_ref2, 2);

	    var fragmentShader = _ref3[0];
	    var vertexShader = _ref3[1];
	...
	function initTileTextures(images) {
	  textures = images.map(function (img) {
	...
	function initSamplingScreen() {
	  ...
	  var x2 = void 0;
	  var y2 = void 0;
	  tileVertexPositionBuffers = textures.map(function (texture, idx) {
	...
	function drawSamplingScreen() {
	  ...
	  tileVertexPositionBuffers.forEach(function (tileVertexPositionBuffer, idx) {
...
;
//# sourceMappingURL=roll-over.js.map
